...
1. **[HeadCount](https://github.com/chmcbs/HeadCount)** — Counting wheat heads in field images using semantic segmentation with a distance transform (computer vision)
